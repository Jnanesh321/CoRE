    ...
    <footer className="site-footer">
      <div className="container footer-inner">
        <div>
          ...
          <p style={{fontSize: '0.85rem', opacity: 0.7}}>We are a community of engineering students passionate about learning, growing, and exploring various fields of engineering.</p>
        </div>
